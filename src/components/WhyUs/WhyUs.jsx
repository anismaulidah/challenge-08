...
import thumbsUp from '../../assets/images/icon/thumbs-up.png'
import price from '../../assets/images/icon/price.png'
import hours from '../../assets/images/icon/24hrs.png'
import professional from "../../assets/images/icon/professional.png"
